...
import au.edu.unsw.soacourse.foundIT.dao.BooksDao;
import au.edu.unsw.soacourse.foundIT.model.Book;
...
public class BooksResource {
	...
	public Book newBook(
		...
		Book b = new Book("3",title);
		if (detail!=null){
			b.setDetail(detail);
		}
		BooksDao.instance.getStore().put("3", b);
