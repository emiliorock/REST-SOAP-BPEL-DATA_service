...
<%
	...
	CompanyProfile currentuser = (CompanyProfile) session.getAttribute("userProfileSession");
	// check user type
	if (userBean == null) {
				...
				<div class="col-lg-9 col-md-9 col-lg-offset-2 col-md-offset-2">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h1>
								<small>Create Company Profile</small>
							</h1>
						</div>
							...
							<form name="myForm" role="form" class="form-horizontal">
								...
								<div class="form-group">
									<div class="col-sm-offset-5">
										...
										<button class="btn" ng-click="createpro()" type="submit">submit</button>
													...
													<div class="modal-dialog">
														...
														<div class="modal-content">
															<div class="modal-header">
																...
																<h4 class="modal-title">Failed to Update</h4>
															</div>
															<div class="modal-body">
																<p>Please re-fill your information follow the
																	instructions!</p>
															</div>
															<div class="modal-footer">
																<button type="button" class="btn btn-default"
				...
				$scope.master = {		
					...
					"intro" : ""
								...
								$scope.createpro = function() {
									$http
											.post(
													'./CompanyController?action=createpro',
													$scope.user)
											.success(
													function(response) {
